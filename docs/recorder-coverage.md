...
| Arcade narration      | AI narration lines during Teach and Cinema (no UI control; issued by the `arcade_narrate` tool)                                                                                                                                                                                                                                                | `lesson.note` (the text is the caption on replay)                                                                                                                   |
