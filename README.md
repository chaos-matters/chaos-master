...
- **An agent at the controls** — WebMCP tools let an agent drive the editor and the Lumen Arcade modes, recording every step as a replayable lesson. See [docs/webmcp.md](docs/webmcp.md).
