...
![TypeGPU](https://img.shields.io/badge/TypeGPU-6143FF?style=for-the-badge&logo=webgpu&logoColor=white)

WebGPU based IFS Flame Generator for Artists and Explorers — formerly known as **Chaos Master**. High-performance, real-time fractal generation using modern web standards.

[**Launch Lumen Apeiron**](https://lumenapeiron.com)

## Gallery

<!-- IMAGE_PLACEHOLDER_START -->

![Lumen Apeiron Initial Flame](assets/chaos-master/images/initial-flame.jpg)
